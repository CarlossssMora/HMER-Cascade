...
```text
classify_ground_truth_differences.py
```
...
```text
compare_crohme_sources_2014.csv
compare_crohme_sources_2014_summary.txt
```
...
```text
ground_truth_cross_evaluation_2014.csv
ground_truth_differences_2014.csv
ground_truth_analysis_2014_summary.txt
```
...
```text
ground_truth_difference_classification_2014.csv
ground_truth_token_changes_2014.csv
ground_truth_difference_classification_2014_summary.txt
```

---

### `analyze_limits_normalization.py`
...
```text
limits_normalization_cross_evaluation_2014.csv
limits_normalization_residual_gt_differences_2014.csv
limits_normalization_2014_summary.txt
```
...
**Fin del registro de avances — corte 2026-09-05**
